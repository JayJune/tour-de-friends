...
const About = props => {
    return (
        <div className="container-md" style={{textAlign: "left", paddingTop: "40px"}}>
            <h1>About</h1>
            <p>Tour de Friends is a demo project for the 2020 NTT TDF hackathon. This website was created by team tour de memes who are <a href="https://github.com/edbertc">edbertc</a>, <a href="https://github.com/Pruneyy">Pruneyy</a>, <a href="https://github.com/vampirate">vampirate</a>, <a href="https://github.com/JayJune">JayJune</a>, and yunyeet. You can find the code repository for this project <a href="https://github.com/JayJune/tour-de-friends">here.</a> </p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tour de friends.</p>
                </li>
                <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                <li><strong>Website</strong> refers to Tour de friends, accessible from https://jayjune.github.io/tour-de-friends/</li>        <li><strong>Service</strong> refers to the Website.</li>
            ...
            <ul>
                <li>By email: jijun.xiong@gmail.com</li>
            </ul>
        </div>
    )
}
